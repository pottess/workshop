import svgPaths from "./svg-4jo4v9ykmu";
...
export default function ClbStatusAtualizado() {
  return (
    <div className="content-stretch flex items-center relative size-full" data-name="CLB-Status [ATUALIZADO]">
      <div className="bg-[#deecff] content-stretch flex gap-[4px] h-[24px] items-center px-[8px] py-[4px] relative rounded-[2px] shrink-0" data-name="_Status-Base">
        <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="_Badge">
          <div className="relative shrink-0 size-[12px]" data-name="Icons/Info-fill">
            <div className="absolute inset-[8.33%_6.36%_8.33%_10.31%]" data-name="Vector">
              <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
                <path d={svgPaths.p163f3871} fill="var(--fill-0, #2B83F7)" id="Vector" />
              </svg>
            </div>
          </div>
        </div>
